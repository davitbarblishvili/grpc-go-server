...
type CalculatorService_FindMaximumClient interface {
	...
	Recv() (*FindMaximumRresponse, error)
	grpc.ClientStream
}
...
func (x *calculatorServiceFindMaximumClient) Recv() (*FindMaximumRresponse, error) {
	m := new(FindMaximumRresponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type CalculatorService_FindMaximumServer interface {
	Send(*FindMaximumRresponse) error
...
func (x *calculatorServiceFindMaximumServer) Send(m *FindMaximumRresponse) error {
	return x.ServerStream.SendMsg(m)
}
